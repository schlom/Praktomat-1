...
# but you are not forced to write your tests with that above frameworks
    ...
    _test_name = models.CharField(
            max_length=100,
            help_text=_("The fully qualified name of the test case executable (with file ending like .exe or .out)"),
    ...
    _sol_name =  models.CharField(
            max_length=100,
            help_text=_("base filename ( = filename without file ending!) for interaction with  MUT (Module-Under-Test)<br>"
            +"The file ending to use gets determined by your chosen Link type.<br>"
            ),
    ...
    # TODO: How to deal with students static c-functions. Think again how to interact with scriptfile dressObjects from this Checker
        ...
        if not copyTestFileArchive_result is not None:
