...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('email_validation_regex', models.CharField(default='.*@(stud.)?fra-uas.de', help_text=b'Regular expression used to check the email domain of registering users.', max_length=200, blank=True)),
